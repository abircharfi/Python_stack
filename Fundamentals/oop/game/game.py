...
class Warrior(Character):
  ...
  #eeeeeeeeeeeeee  # Instance Method: Overriding the parent 'take_damage' method to reduce the damage when the Warrior is defending!
    def take_damage(self, damage):
...
def play_turn(player1, player2):
    ...
    if choice == 's' and isinstance(player1 , Mage): #''''''''''''''''''''''
        ...
        player1.attack(player2) #''''''''''''''' attack method (istance)
